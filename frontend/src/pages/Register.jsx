...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-auth-gradient relative overflow-hidden">
      {/* Floating orbs */}
      <div className="absolute top-10 right-20 w-80 h-80 bg-purple-600/10 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-10 left-20 w-72 h-72 bg-indigo-600/10 rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }} />
      ...
      <div className="w-full max-w-md mx-4 animate-fade-in-up">
        ...
        <div className="glass rounded-2xl p-8 animate-pulse-glow">
          ...
          <p className="text-slate-400 text-sm mb-6">Join the academic management system</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              {form.password.length > 0 && form.password.length < 6 && (
                <p className="text-amber-400/80 text-xs mt-1.5">⚡ At least 6 characters required</p>
              )}
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-2">Role</label>
              <select name="role" value={form.role} onChange={handleChange} className="select-dark w-full">
